 ...
 */
final class Version20250918065721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dog (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, dog_breed_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, birth_date DATETIME NOT NULL, sex VARCHAR(255) NOT NULL, identity_number VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, status VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_812C397D2BC7B602 (identity_number), INDEX IDX_812C397DA76ED395 (user_id), INDEX IDX_812C397DC0EB1E2E (dog_breed_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, trail_id INT DEFAULT NULL, walk_id INT DEFAULT NULL, date DATETIME NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_14B784185E237E06 (name), INDEX IDX_14B78418A76ED395 (user_id), INDEX IDX_14B7841889B51C5B (trail_id), INDEX IDX_14B784185EEE1B48 (walk_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
